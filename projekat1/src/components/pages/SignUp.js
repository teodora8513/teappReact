...
class SignUp extends Component {
  ...
  handleChange = e => {
    ...
    switch (name) {
      ...
      case "password":
        formErrors.password =
          value.length < 6 ? "minimum 4 characaters required" : "";
        break;
      default:
        break;
    }
          ...
          <form onSubmit={this.handleSubmit} noValidate>
            ...
            <div>
                ...
                <select value={this.state.topic} onChange={this.handleTopicChange}>
                    ...
                    <option value="Pocetnik">Junior</option>
                    <option value="Pocetnik">Medior</option>
                    <option value="Pocetnik">Senior</option>
                </select>
            </div>
